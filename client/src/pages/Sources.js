                ...
                <div className="container px-5 py-24 mx-auto ">
                    <div className="flex flex-col text-center w-full mb-20">
                        ...
                        <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
                            ...
                            Każde z nich jest domyślnie przypisane do jednej z
                            trzech kategorii, tj. orientacji, której dane źródło
                            jest najbliżej - lewica, centrum lub prawica.
                            Najważniejszym czynnikiem wpływającem na każde
                            dopasowanie jest to, jaki charakter według tego
                            źródła ono posiada.
                        </p>
                    </div>
                    ...
                    <div className="flex flex-wrap -m-4">
                        {
                            /* List sources from "Lewica" category */
                            Object.keys(sources)
                                .filter(
                    ...
                    <div className="flex flex-wrap -m-4">
                        {
                            /* List sources from "Centrum" category */
                            Object.keys(sources)
                                .filter(
                    ...
                    <div className="flex flex-wrap -m-4">
                        {
                            /* List sources from "Prawica" category */
                            Object.keys(sources)
                                .filter(
